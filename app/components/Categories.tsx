  ...
  return (
    <div className="pt-3 cursor-pointer pd-6 flex items-center space-x-12 ">
      ...
      <div
        ...
        className={`pb-4 flex flex-col items-center space-y-2 border-b-2 ${
          category == "farm" ? "border-black" : "border-white"
        } opacity-60 hover:border-gray-200 hover:opacity-100`}
      >
        <Image src="/farm.png" alt="farm" width={30} height={30} />
      ...
      <div
        ...
        className={`pb-4 flex flex-col items-center space-y-2 border-b-2 ${
          category == "pool" ? "border-black" : "border-white"
        } opacity-60 hover:border-gray-200 hover:opacity-100`}
      >
      ...
      <div
        ...
        className={`pb-4 flex flex-col items-center space-y-2 border-b-2 ${
          category == "lakeView" ? "border-black" : "border-white"
        } opacity-60 hover:border-gray-200 hover:opacity-100`}
      >
      ...
      <div
        ...
        className={`pb-4 flex flex-col items-center space-y-2 border-b-2 ${
          category == "golfing" ? "border-black" : "border-white"
        } opacity-60 hover:border-gray-200 hover:opacity-100`}
      >
      ...
      <div
        ...
        className={`pb-4 flex flex-col items-center space-y-2 border-b-2 ${
          category == "trending" ? "border-black" : "border-white"
        } opacity-60 hover:border-gray-200 hover:opacity-100`}
      >
      ...
      <div
        ...
        className={`pb-4 flex flex-col items-center space-y-2 border-b-2 ${
          category == "amazingView" ? "border-black" : "border-white"
        } opacity-60 hover:border-gray-200 hover:opacity-100`}
      >
      ...
      <div
        ...
        className={`pb-4 flex flex-col items-center space-y-2 border-b-2 ${
          category == "cabin" ? "border-black" : "border-white"
        } opacity-60 hover:border-gray-200 hover:opacity-100`}
      >
